...
**Môn học**: Lập trình ứng dụng web <br>
**Giảng viên**: Trần Tuấn Dũng <br>
**Nhóm 13** <br>
Thành viên nhóm:
...
1. Người bán khởi tạo sản phẩm đấu giá trên hệ thống.

2. Hệ thống tiến hành kiểm tra và phê duyệt sản phẩm để đảm bảo thông tin đầy đủ và hợp lệ.

3. Người mua tham gia đặt giá trong khoảng thời gian quy định.

4. Khi thời gian đấu giá kết thúc, hệ thống tự động xác định người thắng cuộc dựa trên giá đặt cao nhất.
